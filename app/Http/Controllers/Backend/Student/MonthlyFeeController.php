...
class MonthlyFeeController extends Controller
{
    public function view()
    {
        ...
        return view('backend.student.monthly_fee.view-month-fee',$data);
    }
    ...
    public function getStudent(Request $request)
    {
        ...
        foreach ($all_student as $key => $v) {
            ...
            $color = 'success';
                ...
                $html[$key]['tdsource'] .= '<a class="btn btn-sm btn-'.$color.'" title="Payship" target="_blank" href="'.route("students.month.fee.paysleep").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'&month_id='.$request->month_id.'">Fee Slip</a>';
                $html[$key]['tdsource'] .= '</td>';                
        }
