...
@section('content')
          ...
          <section class="col-md-12">
              <div class="card">
                  <div class="card-header">
                      <h3> Manage Marks Edit
                       
                      </h3>
                      
                  </div>
                  <div class="card-body">
                    <form action="{{ route('students.marks.update') }}" method="POST" id="myForm">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="row d-none" id="marks-entry">
                            ...
                            <button type="submit" class="btn btn-secondary btn-sm">Marks Update</button>
                        </div>
                      </form>
                  </div>
                  {{--  carde body close   --}}
    ...
    <script type="text/javascript">
        $(document).on('click','#search',function(){
            ...
            $.ajax({
                url: "{{ route('get.marks.student.marks.edit') }}",
                type: "GET",
                data: { 'year_id': year_id, 'class_id': class_id, 'asign_subject_id':asign_subject_id, 'exam_type_id': exam_type_id},
                success: function(data) {
                    ...
                    $.each( data,function(key,v){
                        ...
                        '<td> <input type="text" class="form-control form-control-sm" required name="marks[]" value="'+v.marks+'"></td>'+
                        '</td>'+
                        '</tr>';
                    });
        ...
        $(function() {
            $(document).on('change','#class_id',function() {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    data: {'class_id':class_id,'year_id' : year_id , 'asign_subject_id' : asign_subject_id, 'exam_type_id' : exam_type_id},
                    success: function(data){
