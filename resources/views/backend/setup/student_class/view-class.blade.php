          ...
          <section class="col-md-12">
              <div class="card">
                  <div class="card-header">
                      <h3>Class List
                        <a class="btn btn-success btn-sm float-right" href="{{ route('setpus.student.class.add') }} "> <i class="fa fa-plus-circle"></i> Add student class</a>
                      </h3>
                            ...
                            <tr class="{{ $value->id }}">
                                ...
                                <td>
                                  <div class="btn-group" role="group" aria-label="Basic example">
                                      <a type="button" href="{{ route('setpus.student.class.edit',$value->id) }}" class="btn btn-success btn-sm"> <i class="fa fa-edit"></i> </a>
